...
//********************* WLAN Settings **********************************
const char* ssid = "LB-SD";                         // put here your acces point ssid -->  If you use the station an an Accesspoint, put the SSID for your AP here. The SSID for AP should not match an existing network.
const char* password = "56126942568484224772";                 // put here the password - min. 7 chars --> If you use the station as an Accesspoint, put the AP-password here.
IPAddress staticIP(192, 168, 178, 155);                 // put here the static IP --> Used for AP too!
...
void setup() {
  ...
  u8x8.setFont(u8x8_font_5x7_r);                  // Screen font 
  u8x8.clear();
  #endif
